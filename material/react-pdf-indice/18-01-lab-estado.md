...
```
Ahora vamos a crear el componente PanelCodigoSecreto.jsx en la carpeta de components, y
pondremos el código de JSX que pinta el panel. Este componente será un componente de clase.

**Archivo:** `/reactjs-estado-lab/src/components/PanelCodigoSecreto.jsx`
...
**Archivo:** `/reactjs-estado-lab/src/components/App.jsx`
